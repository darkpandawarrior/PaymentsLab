 ...
 * Maven Central (verified: 0 results on a direct Maven Central search, single stale 2024-04 release,
 * no further activity), so it can't be depended on directly; this is our own implementation using
 * its config shape as a starting point.
 *
...
data class GooglePayConfig(
    ...
    val merchantName: String = "PaymentsLab",
