...
<!-- AUTOGEN:badge -->
![Modules](https://img.shields.io/badge/modules-33-success)
<!-- /AUTOGEN:badge -->
...
<!-- AUTOGEN:stats -->
> **At a glance** — **33-module** KMP architecture (19 provider · 4 feature · 7 core), **26** deterministic Roborazzi screenshots. *Numbers auto-generated from `settings.gradle.kts` by `scripts/gen-readme.sh`.*
<!-- /AUTOGEN:stats -->
