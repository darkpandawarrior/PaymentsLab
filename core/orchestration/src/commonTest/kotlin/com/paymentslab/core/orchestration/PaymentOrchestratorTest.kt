...
class PaymentOrchestratorTest {
    ...
    @Test
    fun happyPath_emitsFullTimeline_andSettlesSuccess() = runTest {
    ...
    @Test
    fun journalIsWrittenBeforeGatewayLaunch() = runTest {
    ...
    @Test
    fun serverVerdictOverridesClientSuccess() = runTest {
    ...
    @Test
    fun pendingResult_pollsUntilTerminal() = runTest {
    ...
    @Test
    fun cancelled_settlesWithoutVerifying() = runTest {
        val backend = FakeBackend()
    ...
    @Test
    fun unknownGateway_emitsErrored() = runTest {
    ...
    @Test
    fun recoverPending_resolvesUnresolvedAgainstServer() = runTest {
