 ...
 *
 * Modules the JVM `backend/` consumes (core:protocol, core:payments-api, core:common) add a
 * `jvm()` target in their own build file so the shared DTOs/contracts never drift from the server.
 */
